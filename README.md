## Привет! 👋
Меня зовут Мария, я Manual QA. <br>
...
### Hard skills:
- Теория тестирования
- Написание тест-кейсов, чек-листов, баг-репортов (Jira + Zephyr)
- Тестирование REST API (Postman, Swagger)
- UI-тестирование (DevTools, Figma)
- Анализ логов (OpenSearch), Kafka UI
- Работа с БД (pgAdmin, базовые SQL-запросы)
- Docker (основы работы с контейнерами)

### Soft skills:
- Внимательность к деталям
- Быстрая обучаемость, любознательность
- Умение работать в команде
- Ответственность и фокус на результат
- Гибкость, умение адаптироваться к новым условиям

### Где обучалась:
- Закончила курс «Тестирование ПО» в Нетологии
- Онлайн-курс на Stepik "Введение в SQL и базы данных"
- Книги? статьи на тему тестирования
